...
var OrdersProductsModel = /** @class */ (function () {
    function OrdersProductsModel() {
    }
    OrdersProductsModel.prototype.create = function (order_id, product_id, quantity) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Could not add product. Error: ".concat(error_1));
