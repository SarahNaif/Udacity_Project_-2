...
var user_id;
var prod_id;
describe("⚙️Orders Products Model  -------------- ⚙️", function () {
    ...
    //   -------------------toBeDefined---------------------
    it("Add product to order shoud be defined", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    //   ----------------------------------------
    it("should add a product order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderProductStore.create(order_id, prod_id, 3)];
                case 1:
                    result = _a.sent();
