...
describe("⚙️ Order Model  -------------- ⚙️", function () {
    ...
    it("Should have a ordersByUser method", function () {
    ...
    it("Show method should return a Order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
